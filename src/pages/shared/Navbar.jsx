        ...
        <div className="navbar shadow-sm sticky top-0 z-50 backdrop-blur-md bg-green-50/90 rounded-md">
            ...
            <div className="navbar-start">
                ...
                <div className="dropdown">
                    ...
                    >
                        {links}
                        {/* ADDED AUTH BUTTONS INSIDE DROPDOWN for mobile */}
                        {user ? (
                            <>
                                <li className="mt-2">
                                    <button
                                        onClick={handleLogout}
                                        className="btn btn-outline bg-green-300 text-white hover:bg-green-500 w-full"
                                    >
                                        Log out
                                    </button>
                                </li>
                            ...
                            <>
                                <li className="mt-2">
                                    <Link
                                        className="btn btn-outline hover:bg-green-200 bg-green-300 w-full"
                                        to="/register"
                                    >
                                        Register
                                    </Link>
                ...
                <Link
                    to="/"
                    className="flex items-center gap-2 btn btn-ghost normal-case text-3xl text-green-700 font-bold"
                >
                    <img
                        src={logo}
                        alt="My Blog Logo"
            ...
            <div className="navbar-end gap-2 hidden lg:flex">
                {user ? (
                    <>
                        ...
                        <button
                            onClick={handleLogout}
                            className="btn btn-outline bg-green-300 text-white hover:bg-green-500"
                        >
                            Log out
                        </button>
                    </>
                    ...
                    <>
                        <Link
                            className="btn btn-outline hover:bg-green-200 bg-green-300"
                            to="/register"
                        >
                            Register
                        </Link>
